...
/*
Returns a SQL query string that will create the GoldMedal table with 
ten columns (all required): id, year, city, season, name, country, 
gender, sport, discipline, and event.
*/

const createGoldMedalTable = () => {
  return "CREATE TABLE GoldMedal (id INTEGER PRIMARY KEY, year TEXT NOT NULL, city TEXT NOT NULL, season TEXT NOT NULL, name TEXT NOT NULL, country TEXT NOT NULL, gender TEXT NOT NULL, sport TEXT NOT NULL, discipline TEXT NOT NULL, event TEXT NOT NULL);";
};
...
const mostSummerWins = country => {
  return ("SELECT year, COUNT(*) AS count FROM GoldMedal WHERE country LIKE '" + country + "' AND season LIKE 'summer' GROUP BY year ORDER BY 2 DESC;");
};
...
const mostWinterWins = country => {
  return ("SELECT year, COUNT(*) AS count FROM GoldMedal WHERE country LIKE '" + country + "' AND season LIKE 'winter' GROUP BY year ORDER BY 2 DESC;");
};
...
const bestSport = country => {
  return ("SELECT sport, COUNT(*) AS count FROM GoldMedal WHERE country LIKE '" + country + "' GROUP BY 1 ORDER BY 2 DESC;");
};
...
const bestEvent = country => {
  return ("SELECT event, COUNT(*) AS count FROM GoldMedal WHERE country LIKE '" + country + "' GROUP BY 1 ORDER BY 2 DESC;");
};
...
const numberMenMedalists = country => {
  return ("SELECT COUNT(DISTINCT name) AS count FROM GoldMedal WHERE country LIKE '" + country + "' AND gender LIKE 'men';");
};
...
const numberWomenMedalists = country => {
  return ("SELECT COUNT(DISTINCT name) AS count FROM GoldMedal WHERE country LIKE '" + country + "' AND gender LIKE 'women';");
};
...
const mostMedaledAthlete = country => {
  return ("SELECT name, COUNT(*) AS count FROM GoldMedal WHERE country LIKE '" + country + "' GROUP BY 1 ORDER BY 2 DESC;");
};
...
const orderedMedals = (country, field, sortAscending) => {
  ...
  return ("SELECT * FROM GoldMedal WHERE country LIKE '" + country + "' " + queryOrder() + ";");
};
